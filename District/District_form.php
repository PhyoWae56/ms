...
action="District/District_action.php">
		 <legend>Data of Districts</legend>
		<?php		$id = $_GET['id'];?>
...
function updateMarkerPosition(latLng) {
   ...
   <?
    ...
    var latLng=new google.maps.LatLng(24.34044,89.27697812500003);
    ...
    var marker, i;
	var marker1 = new google.maps.Marker({	position : latLng,	title : 'propinsi',	map : map,	icon:'assets/ico/blue4.png',	draggable :true	});
