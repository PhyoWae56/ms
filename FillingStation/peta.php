...
<body>
		<h2 id="headings"> Filling Station</h2>
<a href='index.php?mod=FillingStation&pg=FillingStation_view'><i class="icon-list"></i>List View</a>
  ...
  <script type="text/javascript">
   ...
   $id=$_GET['id'];
    ...
    '<img src=\"upload/FillingStation/$data->foto\" ' +
    '<ul>'+
